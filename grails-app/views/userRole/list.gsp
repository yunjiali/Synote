...
<div class="nav"><span class="menuButton"><a class="home"
	...
	class="create" action="create">New UserRole</g:link></span></div>
...
<table>
	<thead>
		<tr>
			...
			<g:sortableColumn property="authority" title="UserRole Name" />
		...
		<g:each in="${authorityList}" status="i" var="authority">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td class="actionButtons"><span class="actionButton"> <g:link
					action="show" id="${authority.id}">Show</g:link> </span></td>
			</tr>
		</g:each>
	</tbody>
</table>
...
<div class="paginateButtons"><g:paginate
	total="${org.synote.user.UserRole.count()}" /></div>
</div>
</body>
