	...
	<tbody>
		...
		<tr class="prop">
			<td valign="top" class="name"><g:message
				code="configuration.id.label" default="Id" /></td>
		...
		<tr class="prop">
			<td valign="top" class="name"><g:message
				code="configuration.name.label" default="Name" /></td>
		...
		<tr class="prop">
			<td valign="top" class="name"><g:message
				code="configuration.val.label" default="Val" /></td>
		...
		<tr class="prop">
			<td valign="top" class="name"><g:message
				code="configuration.dateCreated.label" default="Date Created" /></td>

			<td valign="top" class="value"><g:formatDate
				date="${configurationInstance?.dateCreated}" /></td>

		</tr>

		<tr class="prop">
			<td valign="top" class="name"><g:message
				code="configuration.lastUpdated.label" default="Last Updated" /></td>

			<td valign="top" class="value"><g:formatDate
				date="${configurationInstance?.lastUpdated}" /></td>
