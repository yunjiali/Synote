...
<g:form method="post" controller="admin">
	...
	<table>
		<tbody>
			<tr class="prop">
				<td class="name"><label for="contact">Terms and Conditions</label></td>
				<td class="value">
					<textarea id="contact" name="contact" class="tinymce"></textarea>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<div class="buttons"><span class="button"><g:actionSubmit
		class="save" value="Confirm" action="saveContactPage"
