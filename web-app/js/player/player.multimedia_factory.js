...
MultimediaFactory.prototype.getPlayerType = function(recording)
{
	...
	if(file_extension)
	{
		this.encodingFormat = file_extension;
	}
...
MultimediaFactory.prototype.getMultimediaPlayer = function(recording,outer_container, inner_container)
{
	...
	if(playertype == PlayerType.jwplayer)
	{
		...
		//MicroData add media playerType microdata
		var new_meta=mdHelper.createMetaTag();
		mdHelper.setItemprop(new_meta, "playerType");
		mdHelper.setContent(new_meta,"Flash");
	...
	else if(playertype==PlayerType.silverlight)
	{
		...
		//MicroData add media playerType microdata
		mdHelper.setItemprop(new_meta, "playerType");
		mdHelper.setContent(new_meta,"Sliverlight");
		$("#recording_content_div").prepend(new_meta);
	...
	else if(playertype == PlayerType.wmp)
	{
		...
		//MicroData add media playerType microdata
		mdHelper.setItemprop(new_meta, "playerType");
		mdHelper.setContent(new_meta,"Windows Media Player");
		$("#recording_content_div").prepend(new_meta);
